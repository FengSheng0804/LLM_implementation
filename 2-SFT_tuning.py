...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser("MicroLM Supervised Fine-tuning")
    ...
    # ============================ wandb ============================
    # 配置wandb的运行名
    args.wandb_run_name = f"MicroLM-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
